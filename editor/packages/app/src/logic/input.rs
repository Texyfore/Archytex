...
mod tests {
    ...
    fn is_key_down() {
        ...
        input.key(VirtualKeyCode::A, ElementState::Pressed);
        assert!(input.is_key_down(VirtualKeyCode::A));
        input.process();
        assert!(input.is_key_down(VirtualKeyCode::A));
        input.key(VirtualKeyCode::A, ElementState::Released);
        assert!(!input.is_key_down(VirtualKeyCode::A));
    }
    ...
    fn is_button_down() {
        ...
        input.button(MouseButton::Left, ElementState::Pressed);
        assert!(input.is_button_down(MouseButton::Left));
        input.process();
        assert!(input.is_button_down(MouseButton::Left));
        input.button(MouseButton::Left, ElementState::Released);
        assert!(!input.is_button_down(MouseButton::Left));
    }
    ...
    fn mouse_pos() {
        ...
        input.movement(Vector2::new(1.0, 1.0));
