...
elengedtekor az új \emph{test} véglegessé válik.

\subsubsection{Törlés}

Egy vagy több kijelölt \emph{test} törléséhez nyomja le a \emph{Delete} billentyűt.
...
körül lehet forgatni $90^{\circ}$ vagy $-90^{\circ}$-os szögben.
...
A szerkesztő második \emph{módja}, a \emph{lap szerkesztési mód} a \emph{testek} \emph{lapjainak}
manipulációját teszi lehetővé. Az általános műveletek itt is működnek, tehát a \emph{lapok}
szabadon mozgathatók.

\subsubsection{Textúrázás}

A \emph{lap szerkesztési mód} egyetlen \emph{speciális művelete} a \emph{textúrázás}. Válasszon ki
egy tetszőleges \emph{textúrát} a \emph{textúra könyvtárból}, majd jelöljön ki egy vagy több
...
\emph{csúcs szerkesztési mód} nem tartalmaz további \emph{speciális műveleteket.}
...
A \emph{testekkel} ellentétben a \emph{díszítőelemek} bármely tengely körül, bármilyen szögben
forgathatóak. Egy vagy több \emph{díszítőelem} kijelölése után megjelenik a
...
Hasonlóan a \emph{gyors mozgatáshoz}, forgatni csak a forgástenglely kiválasztása után lehet. Ezt
az \emph{X, Y vagy Z} billentyű lenyomásával teheti meg. Miután ez megtörtént, a kijelölt
...
A \emph{díszelemek} másolása teljesen úgy működik, mint a \emph{testek} másolása.

\subsection{Mentés és renderelés}

Az Archytex szolgáltatás ingyen tárhelyet biztosít a jeleneteknek és képeknek. Az épp betöltött
jelenet mentéséhez nyomja meg a \emph{Mentés} gombot.

A kész jelenetekből könnyedén lehet élethű képeket készíteni. Nyomja meg a \emph{Renderelés} gombot,
